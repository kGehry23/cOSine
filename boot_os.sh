...
eval "ld -T linker.ld -o kernel.bin kernel_asm.o kernel.o terminal/terminal.o ../libc/string/string.o ../libc/stdio/stdio.o ../libc/stdlib/stdlib.o ../gdt/gdt.o ../gdt/gdt_asm.o ../idt/idt.o ../idt/idt_asm.o ../memory/memory.o -build-id=none"
