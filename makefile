...
C_OBJS = kernel/kernel.o kernel/tty/terminal.o libc/stdio/stdio.o libc/stdlib/stdlib.o libc/string/string.o task/task.o gdt/gdt.o idt/idt.o memory/frame_allocator.o pic/pic.o drivers/ps2/ps2.o drivers/ps2/keyboard/keyboard.o drivers/ps2/keyboard/keyboard_api.o drivers/ps2/mouse/mouse.o memory/paging/pager.o shell/shell.o
