...
C_OBJS = kernel/kernel.o kernel/tty/terminal.o libc/stdio/stdio.o libc/stdlib/stdlib.o libc/string/string.o gdt/gdt.o idt/idt.o pic/pic.o drivers/ps2/ps2.o
